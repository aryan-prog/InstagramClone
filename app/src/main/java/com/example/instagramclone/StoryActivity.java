...
public class StoryActivity extends Activity implements StoriesProgressView.StoriesListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        story_number=findViewById(R.id.story_number);
        ...
        reference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for(DataSnapshot dataSnapshot:snapshot.getChildren())
                {
                    ...
                    if(timecurrent>story.getTimestart() && timecurrent<story.getTimestart()){
                        images.add(story.getImageurl());
                        storyids.add(story.getStoryid());
                    }
                }
                storiesProgressView.setStoriesCount(images.size());
                storiesProgressView.setStoryDuration(50001);
    ...
    private void seenNumber(final String storyid){
        DatabaseReference reference=FirebaseDatabase.getInstance().getReference("Story").child(userid)
        ...
        reference.addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                story_number.setText(""+snapshot.getChildrenCount());
            }
